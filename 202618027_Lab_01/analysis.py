...
# Highly Rated Books
print("\nTop Rated Books\n")
print(df[df["rating"] == 5][["title", "category", "price"]].head(10))
 
# Most Expensive Books
print("\nMost Expensive Books\n")
print(df.sort_values("price", ascending=False)[["title", "category", "price"]].head(10))

# Best Value Books
print("\nBest Value Books\n")
print(df.sort_values("value_score", ascending=False)[["title", "price", "rating", "value_score"]].head(10))
